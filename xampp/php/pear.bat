...
FOR %%x IN ("\Users\i171876\Desktop\portfolio provisoire\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\i171876\Desktop\portfolio provisoire\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\i171876\Desktop\portfolio provisoire\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\i171876\Desktop\portfolio provisoire\php\php.exe"
